...
export class RequestCancelledError extends McpError {
    constructor(requestId) {
        super(REQUEST_CANCELLED, 'Request cancelled', requestId !== undefined ? { requestId } : undefined);
...
export class ContentTooLargeError extends McpError {
    constructor(actualSize, maxSize) {
        const data = actualSize !== undefined || maxSize !== undefined
            ? { actualSize, maxSize }
            : undefined;
...
export function createInvalidRequest(message, data) {
...
export function createInvalidParams(message, data) {
 ...
 */
export function createToolErrorResult(message, toolName, details) {
 ...
 */
export function createToolSuccessResult(text) {
    return {
        content: [
            {
                type: 'text',
...
export function fromError(error) {
    ...
    if (error instanceof Error) {
        ...
        return new InternalError(`An internal error occurred: ${error.message}`);
    }
    // String error
 ...
 * @returns A properly formatted JSON-RPC error response
 */
export function createErrorResponseFromError(error, requestId) {
 ...
 */
export function isToolExecutionError(error) {
