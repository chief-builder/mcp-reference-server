 ...
 */
import { z } from 'zod';
import { JsonRpcErrorCodes, createErrorResponse, createJsonRpcError, } from './jsonrpc.js';
// =============================================================================
// Constants
// =============================================================================
...
export class LifecycleManager {
     ...
     */
    checkPreInitialization(message) {
    ...
    handleInitialize(params) {
        ...
        if (this.state !== 'uninitialized') {
            throw new LifecycleError(JsonRpcErrorCodes.INVALID_REQUEST, 'Server already initialized');
        }
        // Validate params
    ...
    handleInitialized() {
        if (this.state !== 'initializing') {
            throw new LifecycleError(JsonRpcErrorCodes.INVALID_REQUEST, `Cannot receive initialized notification in ${this.state} state`);
        }
        this.state = 'ready';
    }
    /**
 ...
 */
export async function handleInitialize(_params) {
