    ...
    async handleMessage(message, context) {
        ...
        try {
            ...
            if (isRequest(message)) {
                ...
                return createErrorResponse(message.id, createJsonRpcError(JsonRpcErrorCodes.INTERNAL_ERROR, errorMessage));
            }
    ...
    async routeMessage(message, context) {
        ...
        switch (method) {
            ...
            case 'tools/call': {
                ...
                if (!parseResult.success) {
                    return createErrorResponse(id, createJsonRpcError(JsonRpcErrorCodes.INVALID_PARAMS, 'Invalid params for tools/call', parseResult.error.format()));
                }
            ...
            case 'completion/complete': {
                ...
                if (!parseResult.success) {
                    return createErrorResponse(id, createJsonRpcError(JsonRpcErrorCodes.INVALID_PARAMS, 'Invalid params for completion/complete', parseResult.error.format()));
                }
