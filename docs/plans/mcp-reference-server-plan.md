...
| Domain | Description |
|--------|-------------|
| protocol | Core JSON-RPC 2.0, lifecycle, capabilities |
| transport | stdio and HTTP transport layers |
| auth | OAuth 2.1, PKCE, token management |
| tools | Tool registry, executor, sample implementations |
| observability | OpenTelemetry, logging, health checks |
| cross-cutting | Testing, configuration, project setup |
