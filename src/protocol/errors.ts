...
export function createInvalidRequest(data?: unknown): McpError {
...
export function createInvalidParams(data?: unknown): McpError {
  return new McpError(INVALID_PARAMS, 'Invalid params', data);
}

export function createInternalError(data?: unknown): McpError {
