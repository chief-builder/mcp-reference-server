...
export const calculatorInputJsonSchema: JsonSchema = {
  type: 'object',
  properties: {
    operation: {
      type: 'string',
 ...
 */
export async function calculateHandler(args: unknown): Promise<ToolResult> {
...
export const calculatorTool: Tool = {
  ...
  title: 'Calculator',
  description:
    'Perform basic arithmetic operations. Supports addition, subtraction, multiplication, and division of two numbers.',
 ...
 */
export function registerCalculatorTool(registry: ToolRegistry): void {
